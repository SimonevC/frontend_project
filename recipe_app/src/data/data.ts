export const recipeList = [
  ...
  },
  {
    ...
    mealType: 'Dinner',
    ingredients: [
      { name: 'Spaghetti', quantity: 50, unit: 'g' },
      { name: 'Pancetta or guanciale', quantity: 25, unit: 'g' },
      { name: 'Eggs', quantity: 1, unit: 'large' },
      { name: 'Egg yolks', quantity: 1, unit: 'large' },
      { name: 'Pecorino Romano cheese', quantity: 12, unit: 'g' },
      { name: 'Garlic (optional)', quantity: 0.5, unit: 'clove' },
      { name: 'Salt', quantity: 1, unit: 'pinch' },
      { name: 'Black pepper', quantity: 1, unit: 'pinch' },
      { name: 'Reserved pasta water', quantity: 1, unit: 'tbsp' },
    ],
    basic_people: 4,
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Basil leaves', quantity: 10, unit: 'g' },
      { name: 'Pine nuts', quantity: 5, unit: 'g' },
      { name: 'Garlic', quantity: 1, unit: 'clove' },
      { name: 'Parmesan cheese', quantity: 7, unit: 'g' },
  ...
  },
  {
    ...
    mealType: 'Snack',
    ingredients: [
      { name: 'Ripe bananas', quantity: 0.2, unit: 'medium' },
      { name: 'All-purpose flour', quantity: 10, unit: 'g' },
      { name: 'Sugar', quantity: 5, unit: 'g' },
      { name: 'Eggs', quantity: 0.1, unit: 'large' },
      { name: 'Butter, melted', quantity: 4, unit: 'g' },
      { name: 'Baking soda', quantity: 0.1, unit: 'tsp' },
      { name: 'Salt', quantity: 0.05, unit: 'tsp' },
      { name: 'Vanilla extract', quantity: 0.1, unit: 'tsp' },
    ],
    basic_people: 12,
    instructions: [
